...
### Serialization Layer
Serialization available through the `JsonSerializer`, supports a select few types, see `JsonSerializer` for supported types. Deserialization is not implemented yet, and may never be.
